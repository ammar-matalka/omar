...
@section('page-title', __('Create Subject'))
...
<div class="create-subject-container">
    <div class="form-card fade-in">
        <div class="form-header">
            ...
            <p class="form-subtitle">{{ __('Add a new subject to organize your educational content') }}</p>
        </div>
                    ...
                    <div class="form-grid">
                        <div class="form-row single">
                            <div class="form-group">
                                ...
                                @enderror
                                <div class="form-help">{{ __('Optional subject icon or representative image') }}</div>
...
<script>
    ...
    function loadGrades(platformId) {
        ...
        // Clear and disable grade select
    ...
    document.getElementById('subjectForm').addEventListener('submit', function(e) {
        ...
        if (!name) {
            e.preventDefault();
            alert('{{ __("Please enter a subject name") }}');
