...
@section('page-title', __('Create Platform'))
...
@section('content')
<div class="create-platform-container">
    <div class="form-card fade-in">
        <div class="form-header">
            ...
            <p class="form-subtitle">{{ __('Add a new educational platform to organize your content') }}</p>
        </div>
        
        <form action="{{ route('admin.platforms.store') }}" method="POST" enctype="multipart/form-data" id="platformForm">
            @csrf
                    ...
                    <div class="form-grid">
                        <div class="form-row single">
                            <div class="form-group">
                                ...
                                @enderror
                                <div class="form-help">{{ __('Optional platform logo or representative image') }}</div>
...
<script>
    ...
    document.getElementById('platformForm').addEventListener('submit', function(e) {
        ...
        if (!name) {
            e.preventDefault();
            alert('{{ __("Please enter a platform name") }}');
