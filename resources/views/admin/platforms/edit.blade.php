...
@section('page-title', __('Edit Platform'))
...
@section('breadcrumb')
    ...
    <div class="breadcrumb-item">
        <i class="fas fa-chevron-right"></i>
        {{ __('Edit') }} - {{ $platform->name }}
    </div>
@endsection

@push('styles')
<style>
    .edit-platform-container {
        max-width: 800px;
        margin: 0 auto;
    }
...
@section('content')
<div class="edit-platform-container">
    <div class="form-card fade-in">
        <div class="form-header">
            ...
            <p class="form-subtitle">{{ __('Update platform information and settings') }}</p>
        </div>
        
        <form action="{{ route('admin.platforms.update', $platform) }}" method="POST" enctype="multipart/form-data" id="platformForm">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-grid">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                @enderror
                                <div class="form-help">{{ __('Choose a clear name for the educational platform') }}</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="name_ar" class="form-label">
                                    {{ __('Platform Name (Arabic)') }}
                                ...
                                @enderror
                                <div class="form-help">{{ __('Optional Arabic translation of the platform name') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <textarea 
                                    ...
                                    data-original="{{ $platform->description }}"
                                ...
                                @enderror
                                <div class="form-help">{{ __('Describe the purpose and content of this platform') }}</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea 
                                    ...
                                    data-original="{{ $platform->description_ar }}"
                                >{{ old('description_ar', $platform->description_ar) }}</textarea>
                    ...
                    @if($platform->image)
                        <div class="current-image">
                            ...
                            <div class="current-image-container">
                                <img src="{{ Storage::url($platform->image) }}" alt="{{ $platform->name }}" class="current-image-img">
                            </div>
                            <button type="button" class="remove-current" onclick="removePlatformImage()">
                        ...
                        <div class="form-row single">
                            <div class="form-group">
                                <label for="image" class="form-label">
                                    {{ $platform->image ? __('Replace Image') : __('Upload Image') }}
                                ...
                                <div class="image-upload-area" onclick="document.getElementById('image').click()">
                                    ...
                                    <div class="upload-content">
                                        ...
                                        <div class="upload-text">
                                            {{ $platform->image ? __('Click to replace image or drag and drop') : __('Click to upload or drag and drop') }}
                                        </div>
                                ...
                                @enderror
                                <div class="form-help">
                                    {{ $platform->image ? __('Upload a new image to replace the current one') : __('Optional platform logo or representative image') }}
                                </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox-group">
                                    <input 
                                        ...
                                        data-original="{{ $platform->is_active ? '1' : '0' }}"
                                    >
                                ...
                                <div class="form-help">{{ __('Make the platform available for use') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-actions">
                ...
                <div class="btn-group">
                    <a href="{{ route('admin.platforms.show', $platform) }}" class="btn btn-secondary">
...
<script>
    ...
    // Remove platform image (add hidden input to mark for deletion)
    function removePlatformImage() {
        if (confirm('{{ __("Are you sure you want to remove the current image?") }}')) {
            ...
            deleteInput.value = '1';
            document.getElementById('platformForm').appendChild(deleteInput);
