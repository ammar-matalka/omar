...
<div class="auth-container">
    <div class="auth-card fade-in">
        ...
        <div class="auth-header">
            ...
            <p class="auth-subtitle">{{ __('Please enter your new password below') }}</p>
        </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="auth-form" id="resetForm">
                ...
                <div class="form-group">
                    ...
                    <div class="password-strength">
                        <div class="strength-title">{{ __('Password Requirements') }}</div>
...
<script>
    ...
    function updateSubmitButton() {
        ...
        if (isPasswordStrong && doPasswordsMatch && password.length > 0 && confirmPassword.length > 0) {
    ...
    document.getElementById('password-confirm').addEventListener('input', updateSubmitButton);
    ...
    // Auto-focus password input after page load
