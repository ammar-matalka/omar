...
@section('title', 'الدوسيات التعليمية الورقية')
...
<div class="container" style="margin-top: var(--space-xl); margin-bottom: var(--space-3xl);">
    <!-- Header Section -->
    <div class="form-header" style="text-align: center; margin-bottom: var(--space-2xl); padding: var(--space-2xl); background: linear-gradient(135deg, var(--accent-50), var(--warning-50)); border-radius: var(--radius-xl); position: relative; overflow: hidden;">
        <!-- Background Pattern -->
        <div style="position: absolute; top: -30px; right: -30px; width: 120px; height: 120px; background: linear-gradient(135deg, var(--accent-200), var(--accent-300)); border-radius: 50%; opacity: 0.4;"></div>
        <div style="position: absolute; bottom: -40px; left: -40px; width: 100px; height: 100px; background: linear-gradient(135deg, var(--warning-200), var(--warning-300)); border-radius: 50%; opacity: 0.4;"></div>
        ...
        <div style="position: relative; z-index: 2;">
            ...
            <nav style="margin-bottom: var(--space-lg);">
                <div style="display: flex; align-items: center; justify-content: center; gap: var(--space-sm); font-size: 0.9rem; color: var(--gray-600);">
                    <a href="{{ route('educational.index') }}" style="color: var(--accent-600); text-decoration: none; transition: color 0.2s;">النظام التعليمي</a>
                    <i class="fas fa-chevron-left" style="font-size: 0.7rem; color: var(--gray-400);"></i>
                    <span style="color: var(--gray-800); font-weight: 600;">الدوسيات الورقية</span>
                </div>
            </nav>
            
            <div style="font-size: 3rem; margin-bottom: var(--space-md);">📚</div>
            <h1 style="font-size: 2rem; font-weight: 800; margin-bottom: var(--space-md); color: var(--gray-800);">
                الدوسيات التعليمية الورقية
            </h1>
            <p style="font-size: 1.1rem; color: var(--gray-600); max-width: 500px; margin: 0 auto;">
                اختر الجيل والمادة والمعلم ومنطقة الشحن للحصول على دوسيتك الورقية
            </p>
        </div>
    </div>
    ...
    <div class="educational-form-container" style="max-width: 800px; margin: 0 auto;">
        <form id="physicalEducationalForm" method="POST" action="{{ route('educational.cart.add') }}">
            @csrf
            ...
            <div class="progress-container" style="margin-bottom: var(--space-2xl);">
                <div style="display: flex; justify-content: space-between; align-items: center; position: relative;">
                    <!-- Progress Line -->
                    <div style="position: absolute; top: 15px; left: 8%; right: 8%; height: 3px; background: var(--gray-200); border-radius: 2px; z-index: 1;">
                        <div id="progressLine" style="height: 100%; background: linear-gradient(90deg, var(--accent-500), var(--accent-600)); border-radius: 2px; width: 0%; transition: width 0.5s ease;"></div>
                    </div>
                    
                    <!-- Steps -->
                    <div class="progress-step active" data-step="1" style="position: relative; z-index: 2; text-align: center;">
                        <div class="step-circle" style="width: 30px; height: 30px; border-radius: 50%; background: var(--accent-500); color: white; display: flex; align-items: center; justify-content: center; font-weight: 600; margin: 0 auto var(--space-xs);">1</div>
                    ...
                    <div class="progress-step" data-step="6" style="position: relative; z-index: 2; text-align: center;">
                        <div class="step-circle" style="width: 30px; height: 30px; border-radius: 50%; background: var(--gray-300); color: white; display: flex; align-items: center; justify-content: center; font-weight: 600; margin: 0 auto var(--space-xs);">6</div>
                        <span style="font-size: 0.8rem; color: var(--gray-600);">الشحن</span>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="packagesLoading" class="loading-state" style="text-align: center; padding: var(--space-2xl); display: none;">
                            <div style="font-size: 2rem; margin-bottom: var(--space-md); opacity: 0.6;">📦</div>
                            <p style="color: var(--gray-600);">جاري تحميل الدوسيات المتاحة...</p>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Step 6: Shipping Region Selection -->
            <div class="form-step" id="step6" style="margin-bottom: var(--space-2xl); display: none;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div style="margin-bottom: var(--space-lg); padding: var(--space-md); background: var(--info-50); border-radius: var(--radius-md); border: 1px solid var(--info-200);">
                            <div style="display: flex; align-items: center; gap: var(--space-sm); margin-bottom: var(--space-sm);">
                                <i class="fas fa-info-circle" style="color: var(--info-600);"></i>
                                <span style="font-weight: 600; color: var(--info-800);">معلومات مهمة عن الشحن</span>
                            </div>
                            <ul style="margin: 0; padding-right: var(--space-lg); color: var(--info-700); font-size: 0.9rem;">
                                <li style="margin-bottom: var(--space-xs);">يتم شحن الدوسيات خلال 2-3 أيام عمل</li>
                                <li style="margin-bottom: var(--space-xs);">التوصيل مجاني للطلبات فوق 50 دينار</li>
                                <li>يمكنك تتبع طلبك من خلال رقم الشحنة</li>
                            </ul>
                        </div>
                        
                        <div id="regionsContainer" class="options-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: var(--space-md);">
                            <!-- Will be populated by JavaScript -->
                        </div>
                        <div id="regionsLoading" class="loading-state" style="text-align: center; padding: var(--space-2xl); display: none;">
                            <div style="font-size: 2rem; margin-bottom: var(--space-md); opacity: 0.6;">🚚</div>
                            <p style="color: var(--gray-600);">جاري تحميل مناطق الشحن...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-step" id="quantityStep" style="margin-bottom: var(--space-2xl); display: none;">
                <div class="card">
                    <div class="card-header" style="background: linear-gradient(135deg, var(--error-50), var(--accent-50));">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Stock Information -->
                        <div id="stockInfo" style="margin-bottom: var(--space-lg); padding: var(--space-md); border-radius: var(--radius-md); display: none;">
                            <div style="display: flex; align-items: center; gap: var(--space-sm); margin-bottom: var(--space-sm);">
                                <i class="fas fa-warehouse" style="color: var(--warning-600);"></i>
                                <span style="font-weight: 600; color: var(--warning-800);">حالة المخزون</span>
                            </div>
                            <div id="stockStatus" style="font-size: 0.9rem;"></div>
                        </div>

                        <!-- Quantity Selection -->
                        <div style="margin-bottom: var(--space-xl);">
                            <label for="quantity" class="form-label" style="font-weight: 600; color: var(--gray-800);">
                                <i class="fas fa-sort-numeric-up" style="margin-left: var(--space-sm); color: var(--accent-600);"></i>
                                عدد الدوسيات المطلوبة
                            </label>
                            <div style="display: flex; align-items: center; gap: var(--space-md); margin-top: var(--space-sm);">
                                ...
                                <input type="number" name="quantity" id="quantity" value="1" min="1" max="5" class="form-input" style="width: 80px; text-align: center; font-weight: 600; font-size: 1.1rem;">
                                <button type="button" id="increaseQty" class="btn btn-secondary" style="padding: var(--space-sm) var(--space-md);">
                                    <i class="fas fa-plus"></i>
                                </button>
                                <span style="color: var(--gray-600); font-size: 0.9rem; margin-right: var(--space-md);">الحد الأقصى: <span id="maxQuantity">5</span> دوسيات</span>
                            </div>
                        </div>

                        <!-- Price Display -->
                        <div id="priceDisplay" style="padding: var(--space-xl); background: linear-gradient(135deg, var(--accent-50), var(--warning-50)); border-radius: var(--radius-lg); border: 2px solid var(--accent-200); text-align: center;">
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: var(--space-lg); margin-bottom: var(--space-lg);">
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--gray-600); margin-bottom: var(--space-xs);">سعر الدوسية الواحدة</div>
                                ...
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--warning-600); margin-bottom: var(--space-xs);">رسوم الشحن</div>
                                    <div id="shippingCost" style="font-size: 1.2rem; font-weight: 700; color: var(--warning-600);">-- دينار</div>
                                </div>
                            </div>
                            <div style="border-top: 2px solid var(--accent-300); padding-top: var(--space-lg);">
                                <div style="font-size: 1rem; color: var(--gray-600); margin-bottom: var(--space-sm);">السعر النهائي</div>
                                <div id="totalPrice" style="font-size: 2rem; font-weight: 900; background: linear-gradient(135deg, var(--accent-600), var(--warning-600)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                                    -- دينار
                                </div>
                            </div>
                            
                            <!-- Free Shipping Indicator -->
                            <div id="freeShippingIndicator" style="margin-top: var(--space-lg); padding: var(--space-md); background: var(--success-50); border: 2px solid var(--success-200); border-radius: var(--radius-md); display: none;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: var(--space-sm); color: var(--success-700);">
                                    <i class="fas fa-gift"></i>
                                    <span style="font-weight: 600;">مبروك! استحققت الشحن المجاني</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-navigation" style="display: flex; justify-content: space-between; align-items: center; margin-top: var(--space-2xl); padding-top: var(--space-xl); border-top: 2px solid var(--gray-200);">
                ...
                <button type="button" id="nextBtn" class="btn btn-accent btn-lg" style="display: none;">
                    التالي
...
<div id="loadingOverlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7); z-index: 9999; justify-content: center; align-items: center;">
    <div style="background: white; padding: var(--space-2xl); border-radius: var(--radius-xl); text-align: center; max-width: 300px;">
        ...
        <h3 style="margin-bottom: var(--space-md); color: var(--gray-800);">جاري التحقق من المخزون...</h3>
