...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('user.profile.show')->with('success', 'تم تحديث الملف الشخصي بنجاح');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('user.profile.show')->with('success', 'تم تغيير كلمة المرور بنجاح');
    }
}